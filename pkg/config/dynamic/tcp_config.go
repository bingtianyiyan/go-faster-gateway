...
import (
	...
	fastergatewaytls "go-faster-gateway/pkg/tls"
...
type RouterTCPTLSConfig struct {
	...
	Domains      []ptypes.Domain `json:"domains,omitempty" toml:"domains,omitempty" yaml:"domains,omitempty" export:"true"`
}
...
type TLSClientConfig struct {
	...
	Certificates       fastergatewaytls.Certificates `description:"Defines a list of secret storing client certificates for mTLS." json:"certificates,omitempty" toml:"certificates,omitempty" yaml:"certificates,omitempty" export:"true"`
